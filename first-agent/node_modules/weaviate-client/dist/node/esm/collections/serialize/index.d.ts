...
import { BatchObject as BatchObjectGRPC, BatchReference as BatchReferenceGRPC } from '../../proto/v1/batch.js';
...
import { AggregateBaseOptions, AggregateHybridOptions, AggregateNearOptions, BatchReference, GenerativeConfigRuntime, GroupByAggregate, GroupedTask, PropertiesMetrics, SinglePrompt } from '../index.js';
...
export declare class Serialize {
    ...
    static batchObject: <T>(collection: string, object: DataObject<T> | NonReferenceInputs<T>, requiresInsertFix: boolean, tenant?: string) => {
        grpc: BatchObjectGRPC;
        object: {
            id: string;
            collection: string;
            tenant: string | undefined;
            properties?: NonReferenceInputs<T> | undefined;
            references?: import("../index.js").ReferenceInputs<T> | undefined;
            vectors?: number[] | import("../index.js").Vectors;
        };
    };
    ...
    static batchReference: (ref: BatchReference) => {
        grpc: BatchReferenceGRPC;
        beacon: string;
    };
