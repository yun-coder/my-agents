...
declare const collections: (connection: Connection, dbVersionSupport: DbVersionSupport) => {
    ...
    export: <TProperties>(name: string) => Promise<CollectionConfig>;
    listAll: () => Promise<CollectionConfig[]>;
    get: <TProperties extends Properties | undefined = undefined, TName extends string = string>(name: TName) => Collection<TProperties, TName, undefined>;
    use: <TProperties extends Properties | undefined = undefined, TName extends string = string, TVectors extends Vectors | undefined = undefined>(name: TName) => Collection<TProperties, TName, TVectors>;
};
