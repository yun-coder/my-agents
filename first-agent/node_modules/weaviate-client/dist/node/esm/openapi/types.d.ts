...
export type WeaviateBackupStatus = BackupCreateStatusResponse['status'] | BackupRestoreStatusResponse['status'];
...
export type WeaviateDropPropertyIndexName = operations['schema.objects.properties.delete']['parameters']['path']['indexName'];
