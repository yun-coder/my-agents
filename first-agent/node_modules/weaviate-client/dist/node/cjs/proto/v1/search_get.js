...
exports.SearchRequest = {
    ...
    fromJSON(object) {
        return {
            ...
            sortBy: globalThis.Array.isArray(object?.sortBy) ? object.sortBy.map((e) => exports.SortBy.fromJSON(e)) : [],
    ...
    fromPartial(object) {
        ...
        message.sortBy = object.sortBy?.map((e) => exports.SortBy.fromPartial(e)) || [];
...
exports.GroupBy = {
    ...
    create(base) {
        return exports.GroupBy.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseGroupBy();
...
exports.SortBy = {
    ...
    create(base) {
        return exports.SortBy.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseSortBy();
...
exports.MetadataRequest = {
    ...
    fromJSON(object) {
        return {
            ...
            vectors: globalThis.Array.isArray(object?.vectors) ? object.vectors.map((e) => globalThis.String(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    create(base) {
        return exports.MetadataRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseMetadataRequest();
...
exports.PropertiesRequest = {
    ...
    create(base) {
        return exports.PropertiesRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBasePropertiesRequest();
        message.nonRefProperties = object.nonRefProperties?.map((e) => e) || [];
        message.refProperties = object.refProperties?.map((e) => exports.RefPropertiesRequest.fromPartial(e)) || [];
        message.objectProperties = object.objectProperties?.map((e) => exports.ObjectPropertiesRequest.fromPartial(e)) || [];
...
exports.ObjectPropertiesRequest = {
    ...
    create(base) {
        return exports.ObjectPropertiesRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseObjectPropertiesRequest();
...
exports.RefPropertiesRequest = {
    ...
    create(base) {
        return exports.RefPropertiesRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseRefPropertiesRequest();
...
exports.Rerank = {
    ...
    create(base) {
        return exports.Rerank.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseRerank();
...
exports.SearchReply = {
    ...
    create(base) {
        return exports.SearchReply.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseSearchReply();
        ...
        message.groupByResults = object.groupByResults?.map((e) => exports.GroupByResult.fromPartial(e)) || [];
...
exports.RerankReply = {
    ...
    create(base) {
        return exports.RerankReply.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseRerankReply();
...
exports.GroupByResult = {
    ...
    create(base) {
        return exports.GroupByResult.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseGroupByResult();
        ...
        message.objects = object.objects?.map((e) => exports.SearchResult.fromPartial(e)) || [];
        message.rerank = (object.rerank !== undefined && object.rerank !== null)
...
exports.MetadataResult = {
    ...
    create(base) {
        return exports.MetadataResult.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseMetadataResult();
...
exports.PropertiesResult = {
    ...
    create(base) {
        return exports.PropertiesResult.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBasePropertiesResult();
        message.refProps = object.refProps?.map((e) => exports.RefPropertiesResult.fromPartial(e)) || [];
        message.targetCollection = object.targetCollection ?? "";
        message.metadata = (object.metadata !== undefined && object.metadata !== null)
            ? exports.MetadataResult.fromPartial(object.metadata)
            : undefined;
...
exports.RefPropertiesResult = {
    ...
    create(base) {
        return exports.RefPropertiesResult.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseRefPropertiesResult();
        message.properties = object.properties?.map((e) => exports.PropertiesResult.fromPartial(e)) || [];
        message.propName = object.propName ?? "";
        return message;
    },
};
