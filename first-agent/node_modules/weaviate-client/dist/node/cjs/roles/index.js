...
const roles = (connection) => {
    return {
        ...
        userAssignments: (roleName) => connection
            ...
            .then(util_js_1.Map.assignedUsers),
        ...
        addPermissions: (roleName, permissions) => connection.postEmpty(`/authz/roles/${roleName}/add-permissions`, {
            permissions: util_js_1.Map.flattenPermissions(permissions).flatMap(util_js_1.Map.permissionToWeaviate),
        }),
        ...
        getGroupAssignments: (roleName) => connection
            ...
            .then(util_js_1.Map.groupsAssignments),
    };
};
exports.permissions = {
    /**
