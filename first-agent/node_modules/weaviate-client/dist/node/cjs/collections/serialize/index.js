...
class Serialize {
    ...
    static batchObject = (collection, object, requiresInsertFix, tenant) => {
        ...
        const uuid = obj.id ? obj.id : (0, uuid_1.v4)();
        return {
            grpc: batch_js_1.BatchObject.fromPartial({
    ...
    static batchObjects = (collection, objects, requiresInsertFix, tenant) => {
        ...
        const iterate = (index) => {
            ...
            const { grpc, object } = Serialize.batchObject(collection, objects[index], requiresInsertFix, tenant);
            objs.push(grpc);
            batch.push(object);
        };
        const waitFor = () => {
    ...
    static batchReference = (ref) => {
        ...
        return {
            grpc: batch_js_1.BatchReference.fromPartial({
