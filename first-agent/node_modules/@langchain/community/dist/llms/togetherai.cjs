...
class TogetherAI extends llms_1.LLM {
    ...
    constructor(inputs) {
        ...
        if (this.isChatModel(this.model)) {
            console.warn(`Warning: Model '${this.model}' appears to be a chat/instruct model. ` +
    ...
    async _call(prompt, options) {
        ...
        if (!response.output && !response.choices) {
            throw new Error(`Unexpected response format from Together AI. The model '${this.model}' may require the ChatTogetherAI class instead of TogetherAI class. ` +
