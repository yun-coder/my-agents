...
exports.AuroraDsqlChatMessageHistory = void 0;
 ...
 * ```
 */
class AuroraDsqlChatMessageHistory extends chat_history_1.BaseListChatMessageHistory {
    /**
    ...
    async addMessage(message) {
        ...
        const map = (0, messages_1.mapChatMessagesToStoredMessages)([message])[0];
...
exports.AuroraDsqlChatMessageHistory = AuroraDsqlChatMessageHistory;
