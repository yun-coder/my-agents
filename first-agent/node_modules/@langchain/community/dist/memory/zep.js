import { Memory as BaseMemory, Message, NotFoundError, ZepClient, } from "@getzep/zep-js";
import { getInputValue, getOutputValue, } from "@langchain/core/memory";
import { getBufferString, AIMessage, ChatMessage, HumanMessage, SystemMessage, } from "@langchain/core/messages";
 ...
 */
export const zepMemoryContextToSystemPrompt = (memory) => {
    let systemPrompt = "";
 ...
 */
export const condenseZepMemoryIntoHumanMessage = (memory) => {
 ...
 */
export const zepMemoryToMessages = (memory, humanPrefix = "Human", aiPrefix = "AI") => {
    const systemPrompt = zepMemoryContextToSystemPrompt(memory);
...
export class ZepMemory extends BaseChatMemory {
    ...
    async loadMemoryVariables(values) {
        ...
        return {
            [this.memoryKey]: this.separateMessages
                ? getBufferString(zepMemoryToMessages(memoryData, this.humanPrefix, this.aiPrefix), this.humanPrefix, this.aiPrefix)
