...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━");
        const basicResponse = yield model.invoke([
        ...
        const systemResponse = yield model.invoke([
...
请直接调用工具并返回结果。`;
        const toolResponse = yield model.invoke([
        ...
        const mathResponse = yield model.invoke([
        ...
        console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━");
        const timeResponse = yield model.invoke([
